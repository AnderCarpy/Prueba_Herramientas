...
namespace Aenit.API.Controllers
{
    ...
    public class CertificadosController : ControllerBase
    {
        ...
        public async Task<ActionResult<Certificado>> PostCertificado(Certificado certificado)
        {
            ...
            return CreatedAtAction("GetCertificado", new { id = certificado.Codigo }, certificado);
        }
        ...
        {
            return _context.Certificados.Any(e => e.Codigo == id);
        }
    }
}
